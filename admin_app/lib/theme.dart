...
/// LibasAI design tokens — copied verbatim from the customer app's
/// `lib/theme.dart` so the admin panel matches the same design handoff.
/// Keep in sync by hand if the customer app's palette/type scale changes.
class AppColors {
